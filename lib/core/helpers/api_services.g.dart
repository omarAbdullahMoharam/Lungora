...
class _ApiServices implements ApiServices {
  ...
  @override
  Future<ArticlesModel> getAllCategoriesRaw() async {
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ArticlesModel _value;

    try {
      _value = ArticlesModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<DiseaseArticleDetailsModel> getDiseaseArticleDetails(int id) async {
    ...
    final _options = _setStreamType<Map<String, dynamic>>(
      Options(method: 'GET', headers: _headers)
          .compose(
            _dio.options,
            'api/Article/GetArticleByIdWithMobile/$id',
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    );

    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DiseaseArticleDetailsModel _value;

    try {
      _value = DiseaseArticleDetailsModel.fromJson(_result.data!);
      log("\n\nDisease article details: ${_value.toJson()}\n\n");
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
